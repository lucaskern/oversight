...
if(roomCurr == room_reveal)
{
	...
	/// @DnDArgument : "var" ""1:" + string(top1)  + " | 2:" + string(top2) + " | 3:" + string(top3)"
	draw_text(room_width / 2, room_height / 2, string("High Scores ") + string("1:" + string(top1)  + " | 2:" + string(top2) + " | 3:" + string(top3)));
